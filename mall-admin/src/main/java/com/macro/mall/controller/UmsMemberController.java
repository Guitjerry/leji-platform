...
public class UmsMemberController {
  ...
  @ResponseBody
  public CommonResult<CommonPage<UmsMember>> list(UmsMemberQuery umsMemberQuery,
                                                @RequestParam(value = "pageSize", defaultValue = "10") Integer pageSize,
                                                @RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum) {
    List<UmsMember> umsMembers = umsMemberService.list(pageNum, pageSize, umsMemberQuery);
