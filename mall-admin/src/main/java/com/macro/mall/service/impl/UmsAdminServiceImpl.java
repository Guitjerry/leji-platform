...
public class UmsAdminServiceImpl implements UmsAdminService {
    ...
    @Override
    public UmsAdmin getAdminByMobile(String mobile) {
        UmsAdminExample example = new UmsAdminExample();
    ...
    public UmsAdmin register(UmsAdminParam umsAdminParam) {
        ...
        umsAdmin.setStatus(CommonConstant.FLAG_YES);
        if(ObjectUtil.isNotNull(umsAdmin.getUsername())) {
            //查询是否有相同用户名的用户
            UmsAdminExample example = new UmsAdminExample();
        ...
        //将密码进行加密操作
        if(ObjectUtil.isNotNull(umsAdmin.getPassword())) {
